...
$searchInput.addEventListener("keydown", e =>{if(e.keyCode === 13)$searchButton.dispatchEvent(click)})
...
$searchButton.addEventListener('click',() => {
	...
	if(request.fileType === "" || /^ *$/.test($searchInput.value)){
		...
		if($bodyDistribution.href.includes('index'))$bodyDistribution.href = "/static/CSS/results.css";
		request.search = "";
